...
| Module | Topic | State | Material outcome |
| --- | --- | --- | --- |
| 1 | Baseline | ACCEPTED | Closed-book baseline established |
| 2 | Current native Projects behavior | ACCEPTED | Official product boundaries refreshed |
| 3 | Requirements and architecture | ACCEPTED | Confidentiality requirement separated from mechanism |
| 4 | Project Instructions | ACCEPTED_AFTER_CORRECTION | 8,000-character Project Instructions ceiling retained as `OBSERVED` |
| 5 | Sources, files, identity | ACCEPTED_AFTER_CORRECTION | Manifest/lifecycle model; route-specific collision evidence |
| 6 | Memory and cross-chat behavior | ACCEPTED | Containment, retrieval, authority, application separated |
| 7 | Sharing, apps, permissions, authority | ACCEPTED | Capability/permission/authorization/approval/execution separated |
| 8 | Parsing, retrieval, visuals, citations | ACCEPTED | Acceptance/parsing/retrieval/attribution pipeline and route-specific visual limits |
| 9 | Release, rollback, cold start | ACCEPTED | Custom release engineering distinguished from native product semantics |
| 10 | Debugging and root cause | ACCEPTED | Layered fault isolation and one-variable debugging |
| 11 | Evaluation and regression | ACCEPTED | Hard gates separated from scored quality |
...
PROJECT_CHAT = NOT_RUNTIME_QUALIFIED
VOICE = NOT_RUNTIME_QUALIFIED
DEEP_RESEARCH = NOT_RUNTIME_QUALIFIED
WORK = NOT_RUNTIME_QUALIFIED
```

### ForgeWatch adversarial repair

```text
DAMAGED_STATE = CONFLICTED
RECOVERY_TARGET = FORGEWATCH_R1_RESTORE_CANDIDATE
REPAIR_PLAN = COMPLETE
